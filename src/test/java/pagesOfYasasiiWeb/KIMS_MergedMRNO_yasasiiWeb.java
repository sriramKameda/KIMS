...
public class KIMS_MergedMRNO_yasasiiWeb extends PageFactoryInitYasasiiWeb {
	...
	public void patReg(String title , String NAME ,String lastName, String DOB , String MBLNO , String ADDRESS , String DOCno,String MRNO ,String Provider ,String MBLNO2 , String DOCno2,String NAme2,String lastName2) throws InterruptedException, IOException, AWTException {
		...
		Thread.sleep(600);
		relatedmrno.sendKeys("G000000076024");
		Thread.sleep(600);
		...
		relatedmrno.sendKeys("G000000130523");
		Thread.sleep(600);
		relatedmrno.sendKeys(Keys.ENTER);
		Thread.sleep(2000);
		relation.click(); 
	...
	//	Thread.sleep(1000);
		...
		File src1=new File("C:\\Users\\sriram\\eclipse-workspace\\KimsYasasiiWeb\\src\\test\\resources\\excelYasasiiWeb\\KIMSDataSheet.xls");
