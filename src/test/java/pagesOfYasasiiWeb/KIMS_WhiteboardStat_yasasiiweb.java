...
public class KIMS_WhiteboardStat_yasasiiweb  extends PageFactoryInitYasasiiWeb{

	public KIMS_WhiteboardStat_yasasiiweb(WebDriver driver) {
		super(driver);
	...
	@FindBy(xpath = "(//label[@class='text-ellipsis blink-bg color-info'])[2]")
	...
	/*	Thread.sleep(5000);
		...
		Servicesearch.clear();
		Thread.sleep(1000);
		Servicesearch.sendKeys("HbA1c" , Keys.ENTER);
		Thread.sleep(1000);
		driver.findElement(By.xpath("//label[normalize-space()='HbA1c']")).click();
		Thread.sleep(1000);
		//Stat1.click();
		//	Plus.click();
		//	Thread.sleep(1000);
...
//		Thread.sleep(1000); 
	...
	public void Whiteboard(String MRNo,String nurseUser,String password,String Site ) throws InterruptedException, AWTException {
	...
	public void roomstatus(String nurseUser,String password) throws InterruptedException {
		...
		Search.click();
		Thread.sleep(1000);
		driver.findElement(By.xpath("//button[@title='Room Check(Ready to Occupy)']")).click();
		//	ActionHold.click();
		Thread.sleep(1000);
		RoomStatus.click();
		Thread.sleep(1000);
