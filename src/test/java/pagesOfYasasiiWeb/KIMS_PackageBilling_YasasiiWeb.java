...
//		Thread.sleep(700);
		...
		searchScheme.clear();
		Thread.sleep(1000);
		searchScheme.sendKeys("Default" , Keys.ENTER);
		Thread.sleep(1000);
		...
		Thread.sleep(1000); 
		tariffBaseCharge.sendKeys("5000");
		Thread.sleep(1000); 
		tariffcontractCharge.click();
		Thread.sleep(1000); 
		tariffcontractCharge.sendKeys("5000");
		Thread.sleep(1000); 
		//		ADJpercent.click();
		//		Thread.sleep(1000); 
		...
		SearchPackage.click();
		Thread.sleep(1000);
		SearchPackage.sendKeys(PackageName, Keys.ENTER);
		Thread.sleep(1000);
		driver.findElement(By.xpath("//div[@class='result-name']")).click();
		Thread.sleep(700);
		Edit.click();
		...
		Thread.sleep(1000);
		SearchPackage.sendKeys("Default" , Keys.ENTER);
		Thread.sleep(1000);
		driver.findElement(By.xpath("//div[@class='result-name']")).click();
		Thread.sleep(700);
		Edit.click();
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//span[@title='KIMSHEALTH Nagarcoil']")).click();
		Thread.sleep(700);
		Add.click();
		Thread.sleep(1000);
		save.click();
