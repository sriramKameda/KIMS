...
public class KIMS_InstructionOrder_Yasasiiweb  extends PageFactoryInitYasasiiWeb {
	...
	@FindBy(xpath = "//div[3]//div[2]//div[2]//div[1]//div[1]//div[5]//app-vitalfields[1]//div[1]//div[1]//form[1]//span[1]//i[1]")
	...
	@FindBy(xpath = "//input[@id='vital240']")
...
//		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		CPOEServiceSearch.sendKeys("Blood Pressure");
		Thread.sleep(1000);
