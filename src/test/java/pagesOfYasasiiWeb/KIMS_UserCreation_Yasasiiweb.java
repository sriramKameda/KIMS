...
public class KIMS_UserCreation_Yasasiiweb   extends PageFactoryInitYasasiiWeb{
	...
	@FindBy(xpath="//button[@title='ConsultRule.addcnsltrule']//i[@class='ki ki-plus']")
	...
	public void Caller(String userId, String MRNO,String Queue_Name) throws InterruptedException, AWTException	{
	...
	public void tariffSetting(String FirstName, String userId) throws InterruptedException, AWTException {
		...
		department1.click();
		Thread.sleep(600);
		driver.findElement(By.xpath("//li[normalize-space()='General Medcine']")).click();
		Thread.sleep(1000);
		Speciality1.click();
		driver.findElement(By.xpath("//li[normalize-space()='General Medcine']")).click();
		Thread.sleep(1000);
	...
	public void Token_Calling_EMR(String User , String Password , String Site,String MRNo,String FirstName , String Queue_Name,String userId) throws InterruptedException, AWTException {
