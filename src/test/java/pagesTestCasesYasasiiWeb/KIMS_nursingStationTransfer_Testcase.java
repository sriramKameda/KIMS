...
public class KIMS_nursingStationTransfer_Testcase extends TestBaseYasasiiWeb  {
...
public void EMRtransfer(String title,String Name,String Lastname,String Dob, String DocID, String MobNo,String Address,String MRNo,String Provider ,String ADTprovider,String User , String Password , String Site) throws InterruptedException, IOException, AWTException {
		Thread.sleep(2000);
		...
		trans.transfer(MRNo, User, Password, Site);
