...
import pagesOfYasasiiWeb.KIMS_PharmacyBilling_RecomennedDose_Substitute_YasasiiWeb;


public class KIMS_PharmacyBilling_RecomennedDose_Substitute_TestcaseYW    extends TestBaseYasasiiWeb  {
...
public void AdjustRefund(String title,String Name,String Lastname ,String Dob, String DocID, String MobNo,String Address,String MRNo , String PROVIDER, String CHEIFCOMPLAINT , String MEDICINE,String id, String docpassword , String Site ,String AdminID, String AdminPassword) throws InterruptedException, IOException, AWTException {
		Thread.sleep(2000);
		...
		subs.pharmacyBilling(AdminID, AdminPassword, Site, MRNo);
