...
import pagesOfYasasiiWeb.KIMS_AppointmentCheckin_Yasassiweb;

public class KIMS_AppointmentCheckin_TestcaseYW  extends TestBaseYasasiiWeb  {
...
public void Reg(String title,String Name,String lastname, String Dob, String DocID, String MobNo,String Address,String MRNo,String Provider,String service) throws InterruptedException, IOException, AWTException {
		...
		KIMS_AppointmentCheckin_Yasassiweb App = new KIMS_AppointmentCheckin_Yasassiweb(driver);
